  ...
  <aside class="left-sidebar sidebar-dark" id="left-sidebar">
    <div id="sidebar" class="sidebar sidebar-with-footer">
      ...
      <div class="sidebar-left" data-simplebar style="height: 100%;">
        ...
        <router-link class="sidenav-item-link" to="/admin">
          <i class="mdi mdi-briefcase-account-outline"></i>
          <span class="nav-text">Business Dashboard</span>
        </router-link>
      </li>
      <li :class="{ active: isActive('/analytics') }">
        <router-link class="sidenav-item-link" to="/analytics">
      ...
      <li :class="{ active: isActive('/monitorusers') }">
        <router-link class="sidenav-item-link" to="/monitorusers">
